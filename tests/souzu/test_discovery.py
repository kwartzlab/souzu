...
async def test_discover_bambu_devices_without_timeout(
    ...
    with patch("souzu.bambu.discovery.get_running_loop") as mock_get_loop:
        ...
        # Patch logging
        with patch("souzu.bambu.discovery.logging") as mock_logging:
            ...
            # Verify endpoint was created and logging was called
            mock_create_endpoint.assert_called_once()
            mock_logging.info.assert_called_with("Discovery started")
